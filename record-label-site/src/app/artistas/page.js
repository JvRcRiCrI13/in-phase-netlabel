            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                {artists.map((artist) => (
                    <Link
                        ...
                        className="group block overflow-hidden rounded-xl bg-white/5 border border-white/10 transition-all duration-300 hover:border-brand-cyan/50 hover:shadow-[0_0_20px_rgba(56,189,248,0.2)] hover:-translate-y-1"
                    >
                        ...
                        <div className="p-6 relative">
                            <h2 className="text-2xl font-bold tracking-tight mb-2 text-white group-hover:text-brand-cyan transition-colors duration-300">
                                {artist.name}
                            </h2>
